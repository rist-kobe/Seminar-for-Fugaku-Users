...
!=========================================================================
  elp0 = get_elp_time()
  call fapp_start("simple", 1, 1) ! FJ fapp

  do it = 1, NITR
    call mmp_simple(matc, mata, matb, NSIZE)
    matc(1,1) = dble(it)*1.0E-9_DP
  end do
  call fapp_stop("simple", 1, 1) ! FJ fapp
...
!=========================================================================
  elp0 = get_elp_time()
  call fapp_start("matmul", 1, 1) ! FJ fapp
  ...
  call fapp_stop("matmul", 1, 1) ! FJ fapp
  elp = get_elp_time() - elp0
...
!=========================================================================
  elp0 = get_elp_time()
  call fapp_start("rdgemv", 1, 1) ! FJ fapp
...
&             NSIZE, matb(:,j), incx, zero, matc(:,j), incy)
  ...
  call fapp_stop("rdgemv", 1, 1) ! FJ fapp
