...
ax.axvline(CS2MDIM, color='gray', linewidth=1.0)
# FP (DP) peak
ax.axhline(2.0*2*8*2, color='red', linewidth=2.0)

#ax.set_title('A64FX (2.2GHz) \nwith Fujitsu fccpx and SSL2(BLAS/LAPACK) [fj4.12.0]', fontsize='9')
fig.suptitle('Fugaku (freq=2000, eco_state=0) \nwith fccpx(-Nclang -O3 -msve-vector-bits=512 -ffj-swp) and SSL2 (BLAS/LAPACK) [fj4.12.1]', fontsize='9')
