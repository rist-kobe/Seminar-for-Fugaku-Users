...
data1 = data[ (data['BN'] == "clang") ]
data2 = data[ (data['BN'] == "clang.512.swp") ]
data3 = data[ (data['BN'] == "clang.inlv2") ]
data4 = data[ (data['BN'] == "clang.novec") ]
#data5 = data[ (data['BN'] == "trad.swp") ]
...
ax2.plot(ind,data4['Gflops'],label=(data4['BN'].iloc[0]),\
         color='magenta',linestyle='--',linewidth='1.3', \
         marker='o',markersize='6') #,markerfacecolor='None')
#ax2.plot(ind,data5['Gflops'],label=(data5['BN'].iloc[0]),\
#         color='#4169e1',linestyle='--',linewidth='1.3', \
#         marker='^',markersize='6') #,markerfacecolor='None')
...
# fig.suptitle('polynomial [A64FX(2.2GHz), FCCpx, fj4.12.0]',fontsize='10')
fig.suptitle('polynomial [Fugaku (freq=2200, eco_state=2), FCCpx, fj4.12.1]',fontsize='10')
