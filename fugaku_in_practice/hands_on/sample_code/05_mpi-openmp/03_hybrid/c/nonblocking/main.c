...
int main (int argc, char **argv)
{
  ...
  /* p2p communication along x-, y- direction */ 
  ...
  MPI_Isend(&send_buff[0], nysize_local, MPI_DOUBLE, rank_dest_x, tag, cartComm, &send_req);
  MPI_Irecv(&recv_buff[0], nysize_local, MPI_DOUBLE, rank_src_x , tag, cartComm, &recv_req);
  ...
  MPI_Isend(&send_buff[0], nxsize_local, MPI_DOUBLE, rank_dest_y, tag, cartComm, &send_req);
  MPI_Irecv(&recv_buff[0], nxsize_local, MPI_DOUBLE, rank_src_y , tag, cartComm, &recv_req);
